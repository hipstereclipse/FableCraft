# Naming migration debt (after L3.2 code migration)
...
| `packs/Fablecraft_BP/scripts/fable_emotes.js` | 13 | Avisto, Calran, Fable, FableCraft, Fablecraft, Moryk, Yeron |
...
case variants (for example Guild seals), and the HUD navigation feed still need review.
