...
| W1.2 Lychfield crypt | in-progress | SELF: TLC Conformance — W1.2: add Lychfield crypt landmarks and safe spawns; screenshots/validation/W1.2/; docs/LYCHFIELD_CRYPT.md | PASS (automated); PENDING (manual/reference comparison) | 2026-09-12 |
...
| M | 0 / 6 | 0.0% | 0 | 0 | 0 | 6 |
| C | 2 / 3 | 66.7% | 3 | 1 | 1 | 0 |
| Total | 7 / 45 | 15.6% | 15 | 7 | 8 | 30 |

Pending manual plan checks: 0.3, L3.1, L3.2, L3.3, W1.1, W1.2, C2.
