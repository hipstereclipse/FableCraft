...
| C3 Reproducible conformance scoreboard | done | SELF: TLC Conformance — C3: generate reproducible progress scores; screenshots/validation/C3/ | PASS (automated) | 2026-09-12 |
...
| M | 0 / 6 | 0.0% | 0 | 0 | 0 | 6 |
| C | 2 / 3 | 66.7% | 3 | 1 | 1 | 0 |
| Total | 7 / 45 | 15.6% | 13 | 5 | 6 | 32 |

Pending manual plan checks: 0.3, L3.1, L3.2, L3.3, C2.
