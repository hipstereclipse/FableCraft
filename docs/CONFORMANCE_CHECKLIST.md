...
| W2.4 Grey House and cellar | in-progress | SELF: TLC Conformance — W2.4: add Grey House and navigable cellar; screenshots/validation/W2.4/; docs/GREY_HOUSE.md | PASS (automated); PENDING (manual/reference comparison) | 2026-09-12 |
...
| M | 0 / 6 | 0.0% | 0 | 0 | 0 | 6 |
| C | 2 / 3 | 66.7% | 3 | 1 | 1 | 0 |
| Total | 7 / 45 | 15.6% | 21 | 13 | 14 | 24 |

Pending manual plan checks: 0.3, L3.1, L3.2, L3.3, W1.1, W1.2, W1.3, W1.4, W2.1, W2.2, W2.3, W2.4, C2.
...
[the C2 audit](../screenshots/structures/contract/AUDIT.md): S=29, A=1, B=0, C=0, D=0.
