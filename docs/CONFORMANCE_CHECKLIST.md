...
| Item | Status (todo/in-progress/done) | Evidence (commit + screenshot/validator path) | Grade | Date |
| --- | --- | --- | --- | --- |
| W1.1 Cullis gate | in-progress | SELF: TLC Conformance — W1.1: replace the Cullis gate proxy with a stone disc; screenshots/validation/W1.1/ | PASS (automated); PENDING (manual/reference comparison) | 2026-09-12 |
...
| M | 0 / 6 | 0.0% | 0 | 0 | 0 | 6 |
| C | 2 / 3 | 66.7% | 3 | 1 | 1 | 0 |
| Total | 7 / 45 | 15.6% | 14 | 6 | 7 | 31 |

Pending manual plan checks: 0.3, L3.1, L3.2, L3.3, W1.1, C2.
