...
| C2 Structure-manifest contract | in-progress | SELF: TLC Conformance — C2: validate structure provenance and placement bounds; screenshots/validation/C2/ | PASS (automated); PENDING (manual) | 2026-09-12 |
