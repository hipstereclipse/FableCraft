...
def main():
    ...
    commands = {
        ...
        'guild-activity-tests': ['node', '--experimental-vm-modules', 'scripts/tests/guild_activity.test.mjs'],
        'guild-activity-integration-tests': ['node', '--experimental-vm-modules', 'scripts/tests/guild_activity_integration.test.mjs'],
        ...
        'guild-maze-study-tests': [sys.executable, 'scripts/tests/test_guild_maze_study.py'],
        ...
        'arboretum-tests': [sys.executable, 'scripts/tests/test_arboretum.py'],
        'arboretum-runtime-tests': ['node', '--experimental-vm-modules', 'scripts/tests/arboretum_doors.test.mjs'],
        'arboretum-integration-tests': ['node', '--experimental-vm-modules', 'scripts/tests/arboretum_integration.test.mjs'],
        'alignment-authority-tests': ['node', '--experimental-vm-modules', 'scripts/tests/alignment_authority.test.mjs'],
