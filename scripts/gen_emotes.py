        ...
        "animations": {
            ...
            "animation.npc.will_practice": {
                ...
                "bones": {
                    ...
                    "arm_r": {"rotation": {
                        "0.0": [0, 0, 2], "0.2": [-60, -12, 14],
                        "0.4": [-100, -6, 8], "1.0": [-100, -6, 8],
                        "1.4": [0, 0, 2],
                    }},
                    "arm_l": {"rotation": {
                        "0.0": [0, 0, -2], "0.2": [-45, 12, -14],
                        "0.4": [-72, 14, -20], "1.0": [-72, 14, -20],
                        "1.4": [0, 0, -2],
                    }},
                    "leg_r": {"rotation": {
                        "0.0": [0, 0, 0], "0.3": [-5, 0, 4], "1.4": [0, 0, 0],
                    }},
                    "leg_l": {"rotation": {
                        "0.0": [0, 0, 0], "0.3": [7, 0, -4], "1.4": [0, 0, 0],
                    }},
                },
            },
            "animation.npc.cower": {
...
def emit_registry():
    write_json(BP / "config" / "fable_emotes.json", {
        ...
        "emotes": localize(EMOTES),
    })
    js = (
        "// Generated by scripts/gen_emotes.py. Do not edit by hand.\n"
        f"export const FABLE_EMOTES = {json.dumps(localize(EMOTES), ensure_ascii=False, indent=2)};\n"
