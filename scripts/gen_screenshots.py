...
BLOCK_COLORS = {
    ...
    "minecraft:dark_prismarine_slab": (51, 91, 78),
    ...
    "minecraft:cyan_glazed_terracotta": (38, 134, 152),
...
def main():
    ...
    STRUCT_LABELS = {
        ...
        "arboretum": ("The Arboretum", "Wooded reward grove · winding path · Wellow's Pickhammer", "forest"),
