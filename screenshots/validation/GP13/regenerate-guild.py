...
root=Path.cwd(); out=root/'screenshots/validation/GP13'
...
(out/'targeted-generated-drift.json').write_text(json.dumps({'command':'python screenshots/validation/GP13/regenerate-guild.py','changes':changes,'scope':'GP12 reviewed index plus separately reviewed GP13 patch'},indent=2)+'\n')
