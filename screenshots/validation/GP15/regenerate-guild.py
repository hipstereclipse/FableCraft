...
root=Path.cwd(); out=root/'screenshots/validation/GP15'
...
(out/'targeted-generated-drift.json').write_text(json.dumps({'command':'python screenshots/validation/GP15/regenerate-guild.py','changes':changes,'scope':'GP14 committed baseline plus reviewed GP15 backboard and 46th validation gate'},indent=2)+'\n')
