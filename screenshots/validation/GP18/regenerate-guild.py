...
root=Path.cwd(); out=root/'screenshots/validation/GP18'
...
(out/'targeted-generated-drift.json').write_text(json.dumps({'command':'python screenshots/validation/GP18/regenerate-guild.py','changes':changes,'scope':'GP17 committed baseline plus reviewed GP18 eleven-cell Maze study fixture'},indent=2)+'\n')
