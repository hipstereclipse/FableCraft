...
root=Path.cwd(); out=root/'screenshots/validation/GP12'
...
(out/'targeted-generated-drift.json').write_text(json.dumps({'command':'python screenshots/validation/GP12/regenerate-guild.py','changes':changes,'scope':'GP11 reviewed index plus separately reviewed GP12 patch; no GP13 source'},indent=2)+'\n')
