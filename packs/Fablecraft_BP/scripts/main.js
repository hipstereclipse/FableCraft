...
// GP7: fresh structures already own the ring and Demon Door approach clearance.
// Old completion flags never authorize clearing or repaving saved player cells.
...
const STRUCTS = [
  ...
  { id: "fc:hook_coast", w: 37, h: 20, d: 37, weight: 7, surf: ["snow", "sand", "rock"], theme: "snow", cullis: true,
    ...
    mobSpawns: [[30.5, 3, 20.5], [18.5, 1, 23.5], [23.5, 1, 10.5]] },
